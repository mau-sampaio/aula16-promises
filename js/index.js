...
function renderizarDadosUsuario(dados) {
    ...
    foto.src = dados.resultado[0].imagem.grande;
    const tarjeta = document.querySelector(".tarjeta");
    tarjeta.appendChild(foto);
    const nomeCompleto = document.createElement("h1")
    const coletarDados = dados.resultado[0].nome;
    nomeCompleto.innerText = coletarDados.titulo + " " + coletarDados.primeiro + " " + coletarDados.utlimo;
    tarjeta.appendChild(nomeCompleto);
    const email = document.createElement("div");
    email.innerText = dados.resultado[0].email;
